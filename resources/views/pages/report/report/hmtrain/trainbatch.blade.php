...
@section('content')
    ...
    <div class="card container py-3 px-2 shadow-sm">
        <div class="card-body">
            <div class="tab-pane" id="mop-bulanan" role="tabpanel">
                <div class="row">
                    <form action="{{ Route('HMTSearch') }}" method="POST" class="col-md-5 col-sm-12">
                        @csrf
                        <table class="w-100">
                            <tr>
                                <td>MONTH</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <select name="Site" id="idSite" class="form-select">
                                        <option value="">All</option>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <select name="Unit_class" id="idUnit_class" class="form-select">
                                        <option value="">All</option>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <select name="Training_type" id="idTraining_type" class="form-select">
                                        <option value="">All</option>
    ...
    >
        <div class="card-body">
            <h4 class="text-center mb-2">Train Hours</h4>
                    ...
                    <tbody>
                        @forelse ($Data as $data)
                            <tr class="hover:bg-blue-50 transition duration-200 ease-in-out">
                                ...
                                <td class="text-center">{{ $data->avg_progres }}</td>
                                <td class="text-center">{{ round(($data->avg_progres / 56) * 100, 0) }}%</td>
                            </tr>
                        @empty
                            <tr>
