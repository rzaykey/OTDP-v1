...
{{-- <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm" style="width:5em"
                                    placeholder="Site"></th>
                            <th><input type="text" class="form-control form-control-sm" style="width:5em"
                                    placeholder="Type 1"></th>

                            <th><input type="text" class="form-control form-control-sm" style="width:5em"
                                    placeholder="Period"></th>
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Attendance Ratio">
                            </th>
                            <th><input type="text" class="form-control form-control-sm" placeholder="Discipline"></th>
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Safety Awareness">
                            </th>
                            <th><input type="text" class="form-control form-control-sm" style="width:4em"
                                    placeholder="WH Waste 1"></th>

                            <th><input type="text" class="form-control form-control-sm" style="width:4em"
                                    placeholder="Pty 1"></th>

                            <th><input type="text" class="form-control form-control-sm" placeholder="Eligibility">
                            </th>
                            <th><input type="text" class="form-control form-control-sm" placeholder="Produksi"></th>
                            <th><input type="text" class="form-control form-control-sm" placeholder="Total Point">
                            </th>
                            <th><input type="text" class="form-control form-control-sm" placeholder="Grade"></th>
